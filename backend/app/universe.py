"""Stock universe for the recommendations screen: S&P 500 + Nasdaq-100.

Static constituent lists (deduped on import). Index membership changes a few
times a year; refresh these lists periodically or swap in a live source
(e.g. Wikipedia constituents tables) if drift matters. Share-class tickers
use the Yahoo Finance dash convention (BRK-B, not BRK.B).
"""
...
SP500: tuple[str, ...] = (
    ...
    "OKE", "OMC", "ON", "ORCL", "ORLY", "OTIS", "OXY", "PANW", "PARA",
...
NASDAQ100: tuple[str, ...] = (
    ...
    "AMGN", "AMZN", "ANSS", "APP", "ARM", "ASML", "AVGO", "AXON", "AZN",
    "BIIB", "BKNG", "BKR", "CCEP", "CDNS", "CDW", "CEG", "CHTR", "CMCSA",
    "COST", "CPRT", "CRWD", "CSCO", "CSGP", "CSX", "CTAS", "CTSH", "DASH",
    "DDOG", "DXCM", "EA", "EXC", "FANG", "FAST", "FTNT", "GEHC", "GFS",
    "GILD", "GOOG", "GOOGL", "HON", "IDXX", "ILMN", "INTC", "INTU", "ISRG",
    "KDP", "KHC", "KLAC", "LIN", "LRCX", "LULU", "MAR", "MCHP", "MDB",
    "MDLZ", "MELI", "META", "MNST", "MRNA", "MRVL", "MSFT", "MSTR", "MU",
...
UNIVERSE: tuple[str, ...] = tuple(sorted({*SP500, *NASDAQ100}))
